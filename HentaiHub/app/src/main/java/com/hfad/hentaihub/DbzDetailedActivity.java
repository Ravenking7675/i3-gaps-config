...
public class DbzDetailedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dbz_detailed);
        ...
        imageId =imageId+1;
        SQLiteOpenHelper dbzDatabaseHelper = new DbzDatabase(this);
        try {
            ...
            TextView textView = findViewById(R.id.dbz_text);
            textView.setText(imageName);
            ImageView imageView = findViewById(R.id.dbz_image);
